...
namespace STRIPES.Services.Endpoints.Models
{
    ...
    public partial class FlightPlanShowDto : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_aircraftWakeTurbulence? AircraftWakeTurbulence { get; set; }
...
#nullable restore
        ...
        public global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_altitudeType? AltitudeType { get; set; }
...
#nullable restore
        ...
        public global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_cruisingSpeedType? CruisingSpeedType { get; set; }
...
#nullable restore
        ...
        public global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_flightRules? FlightRules { get; set; }
        /// <summary>The flightType property</summary>
        public global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_flightType? FlightType { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto"/> and sets the default values.
        /// </summary>
        public FlightPlanShowDto()
        {
        ...
        public static global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "aircraftWakeTurbulence", n => { AircraftWakeTurbulence = n.GetEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_aircraftWakeTurbulence>(); } },
                ...
                { "altitudeType", n => { AltitudeType = n.GetEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_altitudeType>(); } },
                { "arrivalId", n => { ArrivalId = n.GetStringValue(); } },
                { "callsign", n => { Callsign = n.GetStringValue(); } },
                { "cruisingSpeed", n => { CruisingSpeed = n.GetStringValue(); } },
                { "cruisingSpeedType", n => { CruisingSpeedType = n.GetEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_cruisingSpeedType>(); } },
                ...
                { "flightRules", n => { FlightRules = n.GetEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_flightRules>(); } },
                { "flightType", n => { FlightType = n.GetEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_flightType>(); } },
                { "id", n => { Id = n.GetDoubleValue(); } },
                { "isArchived", n => { IsArchived = n.GetBoolValue(); } },
                { "level", n => { Level = n.GetStringValue(); } },
                { "pic", n => { Pic = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_aircraftWakeTurbulence>("aircraftWakeTurbulence", AircraftWakeTurbulence);
            ...
            writer.WriteEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_altitudeType>("altitudeType", AltitudeType);
            writer.WriteStringValue("arrivalId", ArrivalId);
            writer.WriteStringValue("callsign", Callsign);
            writer.WriteStringValue("cruisingSpeed", CruisingSpeed);
            writer.WriteEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_cruisingSpeedType>("cruisingSpeedType", CruisingSpeedType);
            ...
            writer.WriteEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_flightRules>("flightRules", FlightRules);
            writer.WriteEnumValue<global::STRIPES.Services.Endpoints.Models.FlightPlanShowDto_flightType>("flightType", FlightType);
            writer.WriteDoubleValue("id", Id);
            writer.WriteBoolValue("isArchived", IsArchived);
            writer.WriteStringValue("level", Level);
            writer.WriteStringValue("pic", Pic);
